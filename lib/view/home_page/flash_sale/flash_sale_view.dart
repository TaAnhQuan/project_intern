...
class FlashSale extends StatelessWidget {
  ...
  }) : _animation = animation, _isVisible = isVisible;
  ...
  Widget build(BuildContext context) {
    return Container(
     ...
     child: Stack(
       children: [
         Container(
           margin: EdgeInsets.only(top: SizeConfig.screenHeight*0,left: 10,right: 10),
           height: SizeConfig.screenHeight*0.18,
           decoration: BoxDecoration(
             color: Colors.red[900]
         ),),
         Container(
           margin: EdgeInsets.only(top: SizeConfig.screenHeight*0.02,left: 1,right: 1),
           height: SizeConfig.screenHeight*0.18,
         ...
         AnimationLinghtFlashSale(isVisible: _isVisible, animation: _animation),
         ],
     ),
    );
  }
      ...
      child: Container(
        ...
        child: Stack(
          ...
          Align(
            ...
            painter: UpsideDownTrianglePainter( Colors.red,),
            )
                                        ),
          ),                                ]),
      ),
