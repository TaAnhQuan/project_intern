                ...
                hasScrollBody: false,
                    child: Column(
                      children: [
                        ...
                        ControllerBodyHomePage(tabController: tabController), // UI thanh tab categories
                        Container(
              ...
              Tab(
                child: Container(
                   alignment: Alignment.center,
                    constraints: const BoxConstraints.expand(),//Tạo các ràng buộc hộp mở rộng để lấp đầy các ràng buộc hộp khá
                  //color: Colors.amber,
                  child: const  Text(
                    " Tab 1 ",
