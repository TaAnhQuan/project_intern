            ...
            Container(
              ...
              child: const CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: AssetImage('assets/image/avatar-default.png'),
                ),
              ),
            ),
                  ...
                  Column(
                    children: [
                      ...
                      Container(
                          ...
                          child: IconButton(
                              onPressed: (){},
                              icon: Image.asset('assets/image/icons/denied_wallet.png'))
                      ),
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: IconButton(
                              ...
                              icon: Image.asset('assets/image/icons/truck.png'))
                      ),
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: IconButton(
                              ...
                              icon: Image.asset('assets/image/icons/credit_card_icon.png'))
                      ),
                  ...
                  Column(
                    children: [
                      ...
                      Container(
                          ...
                          child: IconButton(
                            onPressed: (){},
                            icon: Image.asset('assets/image/icons/contact_us.png'))
                      ),
                      ...
                      TextButton(
                        ...
                        child: SizedBox(
                          width: screenWidth * 0.6,
                            child: const Text('Setting', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.black),)),
                      ),
                  ...
                  child: ButtonBar(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: SizedBox(
                          width: screenWidth * 0.6,
                            child: const Text('Help & Support', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.black),)),
                      ),
                  ...
                  child: ButtonBar(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: SizedBox(
                          width: screenWidth * 0.6,
                            child: const Text('FAQ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.black),)),
                      ),
