  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        width: screenWidth,
        height: screenHeight,
        decoration: const BoxDecoration(color: Color.fromRGBO(255, 179, 71, 1)),
        child: ListView(
          children: [
            Container(
              padding: EdgeInsets.fromLTRB(screenWidth / 20, screenHeight / 4,
                  screenWidth / 4, screenHeight / 20),
              child: const Text(
                'Glad to meet you',
                style: TextStyle(
                    color: Colors.white,
                ...
                child: Row(
                  children: [
                    ...
                    TextButton(
                        onPressed: () {
                          Navigator.push(
                              context, MaterialPageRoute(builder: gotoHome));
                        },
                        child: const Text(
                          'Sign In!',
                          style: TextStyle(
