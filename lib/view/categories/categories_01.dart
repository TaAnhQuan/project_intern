...
class _Categories_01State extends State<Categories_01>
  ...
  final _scrollController =
      ScrollController(); // dieu khien cuon SingleScrollView
          ...
          Container(
            ...
            child: Stack(children: [
              PageView.builder(
                ...
                itemBuilder: (_, index) =>
                    Container(child: listOfFeatureContent[index]),
              ),
              SizedBox(
...
class AnimationLinghtFlashSale extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned(
      top: 10,
      // adjust top position as per your requirement
      left: SizeConfig.screenWidth * 0.902,
      // adjust left position as per your requirement
